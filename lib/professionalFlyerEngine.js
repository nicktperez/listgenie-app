...
const FlyerLearningEngine = require('./flyerLearningEngine.js');
const MarketIntelligenceEngine = require('./marketIntelligenceEngine.js');
const { PROFESSIONAL_FLYER_STYLES, FLYER_COLOR_SCHEMES, FLYER_TYPOGRAPHY_SYSTEMS, FLYER_LAYOUT_SYSTEMS, FLYER_ANIMATION_CONFIGS } = require('./professionalFlyerStyles.js');
...
module.exports = ProfessionalFlyerEngine;

// Also export individual functions for flexibility
module.exports.professionalFlyerEngine = new ProfessionalFlyerEngine();
