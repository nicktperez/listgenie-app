      ...
      <div class="modern-flyer-container">
          ...
          <div class="agent-card">
            ...
            <div class="agent-details">
              <div class="agent-item">
                ...
                <span class="agent-value">${agentInfo?.agentName || 'Contact for details'}</span>
              </div>
              <div class="agent-item">
              ...
              <div class="agent-item">
                ...
                <span class="agent-value">${agentInfo?.agentPhone || 'Contact for details'}</span>
              </div>
              <div class="agent-item">
                <span class="agent-label">Email:</span>
                <span class="agent-value">${agentInfo?.agentEmail || 'Contact for details'}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="footer-section">
          <div class="footer-content">
            ...
            <div class="footer-cta">Call Now: ${agentInfo?.agentPhone || 'Contact for details'}</div>
          </div>
        </div>
      </div>
    `;
